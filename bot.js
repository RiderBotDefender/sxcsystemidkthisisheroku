...
function isYoutube(str) {
 ...
 client.on('message', message => {
     if (message.content === prefix +"imnoobsofuu") {
...
***__وصف عن البوت__***
**
بوت سريع موجود على خوادم مستقلة
مما يضمن اداء اسرع
...
***        __Music orders__***
**
『=paly / تشغيل اغنية بالرابط او الاسم』
『=skip / تخطي الاغنية』
『=vol / تغيير الصوة بالنسبة للمشتركين PREMIUM』
『=stop / اخراج البوت من الروم』
**
 ...
 **
رابط البوت https://discordapp.com/api/oauth2/authorize?client_id=473537639560118292&permissions=8&scope=bot
 **
`);
  message.author.sendEmbed(embed);
   }
 ...
 **
رابط السيرفر https://discord.gg/K983A3e
 **
`);
  message.author.sendEmbed(embed);
   }
